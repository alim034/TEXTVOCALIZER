...
const Home = () => {
  ...
  useEffect(() => {
    const scrollTo = window.localStorage.getItem('scrollToSection');
    if (scrollTo) {
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 dark:from-gray-900 dark:via-gray-900 dark:to-green-950">
      ...
      {/* Features Section */}
      <section id="powerful-features" className="relative py-16 md:py-20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="mt-10 md:mt-14 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8"
          >
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link to="/register">
                  <motion.button
                    whileHover={{ scale: 1.05, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 bg-white/90 dark:bg-gray-900/80 text-green-700 dark:text-green-300 font-semibold rounded-2xl shadow-xl hover:bg-white hover:shadow-glow-green dark:hover:bg-gray-900 transition-all duration-300"
                  >
                    <Mic className="w-5 h-5 mr-2" />
